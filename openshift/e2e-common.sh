...
function install_knative_eventing(){
  header "Installing Knative Eventing Release-Next"

  oc apply -f https://raw.githubusercontent.com/openshift/knative-eventing/release-next/openshift/release/knative-eventing-ci.yaml || return 1
  oc apply -f https://raw.githubusercontent.com/openshift/knative-eventing/release-next/openshift/release/knative-eventing-mtbroker-ci.yaml || return 1
